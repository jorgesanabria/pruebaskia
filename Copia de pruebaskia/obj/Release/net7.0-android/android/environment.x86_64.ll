...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"2552f475-30f1-4aae-aa21-527e936b0fb1\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [27 x i8] c"com.companyname.pruebaskia\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 510, ; number_of_dso_cache_entries
	i32 33555309, ; android_runtime_jnienv_class_token
	i32 100672971, ; jnienv_initialize_method_token
	i32 100672970, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.31 = internal constant [58 x i8] c"libaot-SkiaSharp.Views.Maui.Controls.Compatibility.dll.so\00", align 16
...
@__DSOCacheEntry_name.38 = internal constant [40 x i8] c"libaot-System.Drawing.Primitives.dll.so\00", align 16
...
@__DSOCacheEntry_name.49 = internal constant [16 x i8] c"libSkiaSharp.so\00", align 16
...
@__DSOCacheEntry_name.55 = internal constant [45 x i8] c"libaot-System.Collections.Specialized.dll.so\00", align 16
@__DSOCacheEntry_name.56 = internal constant [24 x i8] c"libaot-SkiaSharp.dll.so\00", align 16
@__DSOCacheEntry_name.57 = internal constant [38 x i8] c"libaot-Microsoft.Maui.Controls.dll.so\00", align 16
@__DSOCacheEntry_name.58 = internal constant [40 x i8] c"libaot-Microsoft.Maui.Essentials.dll.so\00", align 16
@__DSOCacheEntry_name.59 = internal constant [44 x i8] c"libaot-SkiaSharp.Views.Maui.Controls.dll.so\00", align 16
@__DSOCacheEntry_name.60 = internal constant [25 x i8] c"libaot-pruebaskia.dll.so\00", align 16
...
@__DSOCacheEntry_name.64 = internal constant [40 x i8] c"libaot-SkiaSharp.Views.Maui.Core.dll.so\00", align 16
...
@__DSOCacheEntry_name.67 = internal constant [29 x i8] c"libaot-System.Drawing.dll.so\00", align 16
...
@__DSOCacheEntry_name.71 = internal constant [20 x i8] c"libSystem.Native.so\00", align 16
@__DSOCacheEntry_name.72 = internal constant [68 x i8] c"libaot-Microsoft.Extensions.DependencyInjection.Abstractions.dll.so\00", align 16
@__DSOCacheEntry_name.73 = internal constant [61 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.ViewModelSavedState.dll.so\00", align 16
@__DSOCacheEntry_name.74 = internal constant [35 x i8] c"libSystem.IO.Compression.Native.so\00", align 16
@__DSOCacheEntry_name.75 = internal constant [26 x i8] c"libaot-System.Linq.dll.so\00", align 16
@__DSOCacheEntry_name.76 = internal constant [42 x i8] c"libaot-Xamarin.AndroidX.CustomView.dll.so\00", align 16
@__DSOCacheEntry_name.77 = internal constant [16 x i8] c"libmonodroid.so\00", align 16
...
@__DSOCacheEntry_name.85 = internal constant [38 x i8] c"libaot-SkiaSharp.Views.Android.dll.so\00", align 16
...
; dso_cache
@dso_cache = local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	; 0
	...
	; 87
	%struct.DSOCacheEntry {
		i64 3495960462913358227, ; hash 0x30842584c4c2c993, from name: pruebaskia.dll.so
		i8 0, ; ignore
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([61 x i8], [61 x i8]* @__DSOCacheEntry_name.73, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 148
	%struct.DSOCacheEntry {
	...
	; 264
	%struct.DSOCacheEntry {
		i64 10215434346353470497, ; hash 0x8dc4836a10b92c21, from name: aot-pruebaskia.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.60, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 282
	%struct.DSOCacheEntry {
		i64 10952208306125606245, ; hash 0x97fe0f6d58b30d65, from name: libaot-pruebaskia.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.60, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 295
	%struct.DSOCacheEntry {
		i64 11321070343615346047, ; hash 0x9d1c857ef466f57f, from name: aot-pruebaskia
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.60, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 413
	%struct.DSOCacheEntry {
		i64 15089889876346662482, ; hash 0xd16a0ee49367ee52, from name: pruebaskia
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.60, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 439
	%struct.DSOCacheEntry {
		i64 16045682814036211091, ; hash 0xdeadb7817537f593, from name: libaot-pruebaskia
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.60, i32 0, i32 0), ; name
		i8* null; handle
	}, 
